...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer19UL17GEN-00012-fragment.py nevts:5'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer19UL17GEN-00012.root'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    cms.PSet(
        ConfigDescription = cms.string('YMass_80'),
        ConfigWeight = cms.double(400),
        GridpackPath = cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.6.5/NMSSM_XYH_bbgg_MX_XXX_MY_YYY/v1/NMSSM_XYH_bbgg_MX_500_MY_80_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'),
